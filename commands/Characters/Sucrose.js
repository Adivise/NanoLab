...
module.exports = {
    name: "sucrose",
    description: "View character of Sucrose",
    options: [
        {
            name: "type",
    ...
    run: async (interaction, client) => {
        ...
        const genshin = await fetch("https://api.genshin.dev/characters/sucrose").then(res => res.json());
        const attachment = new MessageAttachment("./assets/characters/Sucrose.png", "genshin.png");
