...
module.exports = {
    name: "ayaka",
    description: "View character of Kamisato Ayaka",
    options: [
        {
            name: "type",
    ...
    run: async (interaction, client) => {
        ...
        const genshin = await fetch("https://api.genshin.dev/characters/ayaka").then(res => res.json());
        const attachment = new MessageAttachment("./assets/characters/Ayaka.png", "genshin.png");
