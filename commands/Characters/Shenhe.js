...
module.exports = {
    name: "shenhe",
    description: "View character of Shenhe",
    options: [
        {
            name: "type",
    ...
    run: async (interaction, client) => {
        ...
        const genshin = await fetch("https://api.genshin.dev/characters/shenhe").then(res => res.json());
        const attachment = new MessageAttachment("./assets/characters/Shenhe.png", "genshin.png");
