...
module.exports = {
    name: "kokomi",
    description: "View character of Sangonomiya Kokomi",
    options: [
        {
            name: "type",
    ...
    run: async (interaction, client) => {
        ...
        const genshin = await fetch("https://api.genshin.dev/characters/kokomi").then(res => res.json());
        const attachment = new MessageAttachment("./assets/characters/Kokomi.png", "genshin.png");
