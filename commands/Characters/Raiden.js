...
module.exports = {
    name: "raiden",
    description: "View character of Raiden Shogun",
    options: [
        {
            name: "type",
    ...
    run: async (interaction, client) => {
        ...
        const genshin = await fetch("https://api.genshin.dev/characters/raiden").then(res => res.json());
        const attachment = new MessageAttachment("./assets/characters/Raiden.png", "genshin.png");
