...
module.exports = {
    name: "yoimiya",
    description: "View character of Yoimiya",
    options: [
        {
            name: "type",
    ...
    run: async (interaction, client) => {
        ...
        const genshin = await fetch("https://api.genshin.dev/characters/yoimiya").then(res => res.json());
        const attachment = new MessageAttachment("./assets/characters/Yoimiya.png", "genshin.png");
