...
module.exports = {
    name: "xingqiu",
    description: "View character of Xingqiu",
    options: [
        {
            name: "type",
    ...
    run: async (interaction, client) => {
        ...
        const genshin = await fetch("https://api.genshin.dev/characters/xingqiu").then(res => res.json());
        const attachment = new MessageAttachment("./assets/characters/Xingqiu.png", "genshin.png");
