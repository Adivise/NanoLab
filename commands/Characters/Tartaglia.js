...
module.exports = {
    name: "tartaglia",
    description: "View character of Tartaglia",
    options: [
        {
            name: "type",
    ...
    run: async (interaction, client) => {
        ...
        const genshin = await fetch("https://api.genshin.dev/characters/tartaglia").then(res => res.json());
        const attachment = new MessageAttachment("./assets/characters/Tartaglia.png", "genshin.png");
