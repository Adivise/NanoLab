...
module.exports = {
    name: "keqing",
    description: "View character of Keqing",
    options: [
        {
            name: "type",
    ...
    run: async (interaction, client) => {
        ...
        const genshin = await fetch("https://api.genshin.dev/characters/keqing").then(res => res.json());
        const attachment = new MessageAttachment("./assets/characters/Keqing.png", "genshin.png");
