...
module.exports = {
    name: "rosaria",
    description: "View character of Rosaria",
    options: [
        {
            name: "type",
    ...
    run: async (interaction, client) => {
        ...
        const genshin = await fetch("https://api.genshin.dev/characters/rosaria").then(res => res.json());
        const attachment = new MessageAttachment("./assets/characters/Rosaria.png", "genshin.png");
