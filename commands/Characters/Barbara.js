...
module.exports = {
    name: "barbara",
    description: "View character of Barbara",
    options: [
        {
            name: "type",
    ...
    run: async (interaction, client) => {
        ...
        const genshin = await fetch("https://api.genshin.dev/characters/barbara").then(res => res.json());
        const attachment = new MessageAttachment("./assets/characters/Barbara.png", "genshin.png");
