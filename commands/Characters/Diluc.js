...
module.exports = {
    name: "diluc",
    description: "View character of Diluc",
    options: [
        {
            name: "type",
    ...
    run: async (interaction, client) => {
        ...
        const genshin = await fetch("https://api.genshin.dev/characters/diluc").then(res => res.json());
        const attachment = new MessageAttachment("./assets/characters/Diluc.png", "genshin.png");
