...
module.exports = {
    name: "venti",
    description: "View character of Venti",
    options: [
        {
            name: "type",
    ...
    run: async (interaction, client) => {
        ...
        const genshin = await fetch("https://api.genshin.dev/characters/venti").then(res => res.json());
        const attachment = new MessageAttachment("./assets/characters/Venti.png", "genshin.png");
