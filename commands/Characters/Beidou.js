...
module.exports = {
    name: "beidou",
    description: "View character of Beidou",
    options: [
        {
            name: "type",
    ...
    run: async (interaction, client) => {
        ...
        const genshin = await fetch("https://api.genshin.dev/characters/beidou").then(res => res.json());
        const attachment = new MessageAttachment("./assets/characters/Beidou.png", "genshin.png");
