...
module.exports = {
    name: "lisa",
    description: "View character of Lisa",
    options: [
        {
            name: "type",
    ...
    run: async (interaction, client) => {
        ...
        const genshin = await fetch("https://api.genshin.dev/characters/lisa").then(res => res.json());
        const attachment = new MessageAttachment("./assets/characters/Lisa.png", "genshin.png");
