...
module.exports = {
    name: "kaeya",
    description: "View character of Kaeya",
    options: [
        {
            name: "type",
    ...
    run: async (interaction, client) => {
        ...
        const genshin = await fetch("https://api.genshin.dev/characters/kaeya").then(res => res.json());
        const attachment = new MessageAttachment("./assets/characters/Kaeya.png", "genshin.png");
