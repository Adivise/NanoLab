...
module.exports = {
    name: "gorou",
    description: "View character of Gorou",
    options: [
        {
            name: "type",
    ...
    run: async (interaction, client) => {
        ...
        const genshin = await fetch("https://api.genshin.dev/characters/gorou").then(res => res.json());
        const attachment = new MessageAttachment("./assets/characters/Gorou.png", "genshin.png");
