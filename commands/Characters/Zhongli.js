...
module.exports = {
    name: "zhongli",
    description: "View character of Zhongli",
    options: [
        {
            name: "type",
    ...
    run: async (interaction, client) => {
        ...
        const genshin = await fetch("https://api.genshin.dev/characters/zhongli").then(res => res.json());
        const attachment = new MessageAttachment("./assets/characters/Zhongli.png", "genshin.png");
