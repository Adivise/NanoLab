...
module.exports = {
    name: "jean",
    description: "View character of Jean",
    options: [
        {
            name: "type",
    ...
    run: async (interaction, client) => {
        ...
        const genshin = await fetch("https://api.genshin.dev/characters/jean").then(res => res.json());
        const attachment = new MessageAttachment("./assets/characters/Jean.png", "genshin.png");
