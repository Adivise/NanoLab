...
module.exports = {
    name: "xinyan",
    description: "View character of Xinyan",
    options: [
        {
            name: "type",
    ...
    run: async (interaction, client) => {
        ...
        const genshin = await fetch("https://api.genshin.dev/characters/xinyan").then(res => res.json());
        const attachment = new MessageAttachment("./assets/characters/Xinyan.png", "genshin.png");
