...
module.exports = {
    name: "hutao",
    description: "View character of Hu Tao",
    options: [
        {
            name: "type",
    ...
    run: async (interaction, client) => {
        ...
        const genshin = await fetch("https://api.genshin.dev/characters/hu-tao").then(res => res.json());
        const attachment = new MessageAttachment("./assets/characters/Hutao.png", "genshin.png");
