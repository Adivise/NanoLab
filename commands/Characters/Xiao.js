...
module.exports = {
    name: "xiao",
    description: "View character of Xiao",
    options: [
        {
            name: "type",
    ...
    run: async (interaction, client) => {
        ...
        const genshin = await fetch("https://api.genshin.dev/characters/xiao").then(res => res.json());
        const attachment = new MessageAttachment("./assets/characters/Xiao.png", "genshin.png");
