...
module.exports = {
    name: "ningguang",
    description: "View character of Ningguang",
    options: [
        {
            name: "type",
    ...
    run: async (interaction, client) => {
        ...
        const genshin = await fetch("https://api.genshin.dev/characters/ningguang").then(res => res.json());
        const attachment = new MessageAttachment("./assets/characters/Ningguang.png", "genshin.png");
