...
module.exports = {
    name: "thoma",
    description: "View character of Thoma",
    options: [
        {
            name: "type",
    ...
    run: async (interaction, client) => {
        ...
        const genshin = await fetch("https://api.genshin.dev/characters/thoma").then(res => res.json());
        const attachment = new MessageAttachment("./assets/characters/Thoma.png", "genshin.png");
