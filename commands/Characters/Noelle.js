...
module.exports = {
    name: "noelle",
    description: "View character of Noelle",
    options: [
        {
            name: "type",
    ...
    run: async (interaction, client) => {
        ...
        const genshin = await fetch("https://api.genshin.dev/characters/noelle").then(res => res.json());
        const attachment = new MessageAttachment("./assets/characters/Noelle.png", "genshin.png");
