...
module.exports = {
    name: "sayu",
    description: "View character of Sayu",
    options: [
        {
            name: "type",
    ...
    run: async (interaction, client) => {
        ...
        const genshin = await fetch("https://api.genshin.dev/characters/sayu").then(res => res.json());
        const attachment = new MessageAttachment("./assets/characters/Sayu.png", "genshin.png");
