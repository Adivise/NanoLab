...
module.exports = {
    name: "chongyun",
    description: "View character of Chongyun",
    options: [
        {
            name: "type",
    ...
    run: async (interaction, client) => {
        ...
        const genshin = await fetch("https://api.genshin.dev/characters/chongyun").then(res => res.json());
        const attachment = new MessageAttachment("./assets/characters/Chongyun.png", "genshin.png");
