...
module.exports = {
    name: "qiqi",
    description: "View character of Qiqi",
    options: [
        {
            name: "type",
    ...
    run: async (interaction, client) => {
        ...
        const genshin = await fetch("https://api.genshin.dev/characters/qiqi").then(res => res.json());
        const attachment = new MessageAttachment("./assets/characters/Qiqi.png", "genshin.png");
