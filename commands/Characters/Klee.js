...
module.exports = {
    name: "klee",
    description: "View character of Klee",
    options: [
        {
            name: "type",
    ...
    run: async (interaction, client) => {
        ...
        const genshin = await fetch("https://api.genshin.dev/characters/klee").then(res => res.json());
        const attachment = new MessageAttachment("./assets/characters/Klee.png", "genshin.png");
