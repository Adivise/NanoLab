...
module.exports = {
    name: "kazuha",
    description: "View character of Kaedehara Kazuha",
    options: [
        {
            name: "type",
    ...
    run: async (interaction, client) => {
        ...
        const genshin = await fetch("https://api.genshin.dev/characters/kazuha").then(res => res.json());
        const attachment = new MessageAttachment("./assets/characters/Kazuha.png", "genshin.png");
