...
module.exports = {
    name: "yunjin",
    description: "View character of Yunjin",
    options: [
        {
            name: "type",
    ...
    run: async (interaction, client) => {
        ...
        const genshin = await fetch("https://api.genshin.dev/characters/yun-jin").then(res => res.json());
        const attachment = new MessageAttachment("./assets/characters/Yunjin.png", "genshin.png");
