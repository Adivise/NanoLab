...
module.exports = {
    name: "amber",
    description: "View character of Amber",
    options: [
        {
            name: "type",
    ...
    run: async (interaction, client) => {
        ...
        const genshin = await fetch("https://api.genshin.dev/characters/amber").then(res => res.json());
        const attachment = new MessageAttachment("./assets/characters/Amber.png", "genshin.png");
