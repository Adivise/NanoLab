...
module.exports = {
    name: "razor",
    description: "View character of Razor",
    options: [
        {
            name: "type",
    ...
    run: async (interaction, client) => {
        ...
        const genshin = await fetch("https://api.genshin.dev/characters/razor").then(res => res.json());
        const attachment = new MessageAttachment("./assets/characters/Razor.png", "genshin.png");
