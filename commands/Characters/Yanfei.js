...
module.exports = {
    name: "yanfei",
    description: "View character of Yanfei",
    options: [
        {
            name: "type",
    ...
    run: async (interaction, client) => {
        ...
        const genshin = await fetch("https://api.genshin.dev/characters/yanfei").then(res => res.json());
        const attachment = new MessageAttachment("./assets/characters/Yanfei.png", "genshin.png");
