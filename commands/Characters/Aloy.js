...
module.exports = {
    name: "aloy",
    description: "View character of Aloy",
    options: [
        {
            name: "type",
    ...
    run: async (interaction, client) => {
        ...
        const genshin = await fetch("https://api.genshin.dev/characters/aloy").then(res => res.json());
        const attachment = new MessageAttachment("./assets/characters/Aloy.png", "genshin.png");
