...
module.exports = {
    name: "fischl",
    description: "View character of Fischl",
    options: [
        {
            name: "type",
    ...
    run: async (interaction, client) => {
        ...
        const genshin = await fetch("https://api.genshin.dev/characters/fischl").then(res => res.json());
        const attachment = new MessageAttachment("./assets/characters/Fischl.png", "genshin.png");
