...
module.exports = {
    name: "sara",
    description: "View character of Kujou Sara",
    options: [
        {
            name: "type",
    ...
    run: async (interaction, client) => {
        ...
        const genshin = await fetch("https://api.genshin.dev/characters/sara").then(res => res.json());
        const attachment = new MessageAttachment("./assets/characters/Sara.png", "genshin.png");
