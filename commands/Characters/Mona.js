...
module.exports = {
    name: "mona",
    description: "View character of Mona",
    options: [
        {
            name: "type",
    ...
    run: async (interaction, client) => {
        ...
        const genshin = await fetch("https://api.genshin.dev/characters/mona").then(res => res.json());
        const attachment = new MessageAttachment("./assets/characters/Mona.png", "genshin.png");
