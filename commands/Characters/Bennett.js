...
module.exports = {
    name: "bennett",
    description: "View character of Bennett",
    options: [
        {
            name: "type",
    ...
    run: async (interaction, client) => {
        ...
        const genshin = await fetch("https://api.genshin.dev/characters/bennett").then(res => res.json());
        const attachment = new MessageAttachment("./assets/characters/Bennett.png", "genshin.png");
