...
module.exports = {
    name: "itto",
    description: "View character of Arataki Itto",
    options: [
        {
            name: "type",
    ...
    run: async (interaction, client) => {
        ...
        const genshin = await fetch("https://api.genshin.dev/characters/arataki-itto").then(res => res.json());
        const attachment = new MessageAttachment("./assets/characters/Itto.png", "genshin.png");
