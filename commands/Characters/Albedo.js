...
module.exports = {
    name: "albedo",
    description: "View character of Albedo",
    options: [
        {
            name: "type",
    ...
    run: async (interaction, client) => {
        ...
        const genshin = await fetch("https://api.genshin.dev/characters/albedo").then(res => res.json());
        const attachment = new MessageAttachment("./assets/characters/Albedo.png", "genshin.png");
